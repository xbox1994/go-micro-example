...
// Changes from 3.2: [ZHU HAIHUA]
// - Use glog instead of channel for the better write performance.
package log4go
...
func (log Logger) IntLogf(deep int, lvl Level, format string, args ...interface{}) {
	...
	// old code: pc, _, lineno, ok := runtime.Caller(deep)
	// src := ""
	// if ok {
...
func (log Logger) IntLogTraceId(tid string, ctx context.Context, deep int, lvl Level, format string, args ...interface{}) {
	// Determine caller func
	// _, file, lineno, ok := runtime.Caller(deep)
